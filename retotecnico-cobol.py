...
nombre_archivo = 'data.csv' #Como opción coloqué para poder indicar el nombre de nuestro archivo a leer
...
print('Balance Final: ', round(Reporte_Transacciones[Reporte_Transacciones.tipo == 'Crédito'].monto.sum() - Reporte_Transacciones[Reporte_Transacciones.tipo == 'Débito'].monto.sum(), 2))
